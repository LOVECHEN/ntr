// Package encryption 是 vendored 自 xtls/xray-core proxy/vless/encryption(VLESS Encryption 后量子加密层,
// ML-KEM-768 + X25519),xray 内部依赖(common/crypto/protocol/errors)以本目录 shim 顶掉,
// blake3 换 metacubex/blake3。禁改线格式。
package encryption
...
import (
	...
	crypto "github.com/LOVECHEN/ntr/internal/vlessenc/xcrypto"
	"errors"
