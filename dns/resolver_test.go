...
func TestExchangeAndCache(t *testing.T) {
	...
	r, err := New([]Nameserver{{Tag: "fake", Address: "udp://1.1.1.1:53", Detour: fakeUpstream{calls: &calls}}}, "race")
	if err != nil {
		t.Fatal(err)
	}
...
func TestLookup(t *testing.T) {
	var calls atomic.Int64
	r, _ := New([]Nameserver{{Tag: "fake", Address: "udp://1.1.1.1:53", Detour: fakeUpstream{calls: &calls}}}, "race")
