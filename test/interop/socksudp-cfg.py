...
proxy=(os.environ.get('CLI','cli'),1080); target=(os.environ.get('ECHO','echo'),9999)
msg=b'PINGUDP-ss-42'
...
atyp=data[3]; off=10 if atyp==1 else (22 if atyp==4 else 4+1+data[4]+2)
payload=data[off:]
print('GOT',payload); sys.exit(0 if payload==msg else 1)
